...
Yet in both cases $\varepsilon$ is our "smoke screen" of reality, also known as randomness. One way of looking at our first equation is that it takes a *portion* of the unknown in $\varepsilon$ and converts it into a known ($aX + b$).
